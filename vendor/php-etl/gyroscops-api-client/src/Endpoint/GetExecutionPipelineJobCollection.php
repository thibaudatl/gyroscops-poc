...
class GetExecutionPipelineJobCollection extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return '/runtime/execution-pipeline-jobs';
    }
