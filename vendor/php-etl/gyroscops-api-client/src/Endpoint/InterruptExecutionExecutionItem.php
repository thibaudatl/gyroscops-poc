...
class InterruptExecutionExecutionItem extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/runtime/execution/{id}/interrupt');
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Gyroscops\Api\Exception\InterruptExecutionExecutionItemBadRequestException();
        }
        if (422 === $status) {
            throw new \Gyroscops\Api\Exception\InterruptExecutionExecutionItemUnprocessableEntityException();
        }
        if (404 === $status) {
            throw new \Gyroscops\Api\Exception\InterruptExecutionExecutionItemNotFoundException();
        }
    }
