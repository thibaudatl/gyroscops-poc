...
class ApiSchedulesWorkflowOrganizationGetSubresourceScheduleSubresource extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}', '{workflow}'], [$this->id, $this->workflow], '/runtime/schedule/{id}/workflow/organization');
    }
