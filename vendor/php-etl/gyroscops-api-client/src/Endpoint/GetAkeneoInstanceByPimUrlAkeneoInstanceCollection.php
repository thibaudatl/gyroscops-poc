...
class GetAkeneoInstanceByPimUrlAkeneoInstanceCollection extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return '/gateway/akeneo/instance/from-url';
    }
