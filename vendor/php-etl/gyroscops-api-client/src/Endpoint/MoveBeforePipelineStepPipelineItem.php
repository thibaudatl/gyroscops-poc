...
class MoveBeforePipelineStepPipelineItem extends \Gyroscops\Api\Runtime\Client\BaseEndpoint implements \Gyroscops\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/runtime/pipeline/{id}/step/{code}/move-before');
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Gyroscops\Api\Exception\MoveBeforePipelineStepPipelineItemBadRequestException();
        }
        if (422 === $status) {
            throw new \Gyroscops\Api\Exception\MoveBeforePipelineStepPipelineItemUnprocessableEntityException();
        }
        if (404 === $status) {
