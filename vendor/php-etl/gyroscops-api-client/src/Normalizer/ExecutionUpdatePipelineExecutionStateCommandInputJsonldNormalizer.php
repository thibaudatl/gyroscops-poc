...
class ExecutionUpdatePipelineExecutionStateCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ExecutionUpdatePipelineExecutionStateCommandInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ExecutionUpdatePipelineExecutionStateCommandInputJsonld::class === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('stepsUpdates', $data) && null !== $data['stepsUpdates']) {
            $object->setStepsUpdates($this->denormalizer->denormalize($data['stepsUpdates'], \Gyroscops\Api\Model\UpdateListJsonld::class, 'json', $context));
