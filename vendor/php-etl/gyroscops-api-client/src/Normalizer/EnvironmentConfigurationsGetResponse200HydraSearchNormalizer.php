...
class EnvironmentConfigurationsGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\EnvironmentConfigurationsGetResponse200HydraSearch::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\EnvironmentConfigurationsGetResponse200HydraSearch::class === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\EnvironmentConfigurationsGetResponse200HydraSearch();
        ...
        if (\array_key_exists('hydra:mapping', $data) && null !== $data['hydra:mapping']) {
            ...
            foreach ($data['hydra:mapping'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gyroscops\Api\Model\EnvironmentConfigurationsGetResponse200HydraSearchHydraMappingItem::class, 'json', $context);
            }
