...
class AuthenticationOrganizationIdUsersGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\AuthenticationOrganizationIdUsersGetResponse200::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\AuthenticationOrganizationIdUsersGetResponse200::class === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\AuthenticationOrganizationIdUsersGetResponse200();
        ...
        if (\array_key_exists('hydra:member', $data) && null !== $data['hydra:member']) {
            ...
            foreach ($data['hydra:member'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gyroscops\Api\Model\UserJsonld::class, 'json', $context);
            }
        ...
        if (\array_key_exists('hydra:view', $data) && null !== $data['hydra:view']) {
            $object->setHydraView($this->denormalizer->denormalize($data['hydra:view'], \Gyroscops\Api\Model\AuthenticationOrganizationIdUsersGetResponse200HydraView::class, 'json', $context));
        ...
        if (\array_key_exists('hydra:search', $data) && null !== $data['hydra:search']) {
            $object->setHydraSearch($this->denormalizer->denormalize($data['hydra:search'], \Gyroscops\Api\Model\AuthenticationOrganizationIdUsersGetResponse200HydraSearch::class, 'json', $context));
