...
class ConfigurationRemoveConfigurationValueInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ConfigurationRemoveConfigurationValueInput::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ConfigurationRemoveConfigurationValueInput::class === $data::class;
    }
