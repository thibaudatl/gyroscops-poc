...
class PipelineAddAfterPipelineStepCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\PipelineAddAfterPipelineStepCommandInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\PipelineAddAfterPipelineStepCommandInputJsonld::class === $data::class;
    }
