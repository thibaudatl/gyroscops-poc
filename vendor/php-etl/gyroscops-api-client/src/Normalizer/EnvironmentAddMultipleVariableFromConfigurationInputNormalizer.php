...
class EnvironmentAddMultipleVariableFromConfigurationInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\EnvironmentAddMultipleVariableFromConfigurationInput();
