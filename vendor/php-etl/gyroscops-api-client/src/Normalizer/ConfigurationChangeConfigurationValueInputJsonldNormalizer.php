...
class ConfigurationChangeConfigurationValueInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ConfigurationChangeConfigurationValueInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ConfigurationChangeConfigurationValueInputJsonld::class === $data::class;
    }
