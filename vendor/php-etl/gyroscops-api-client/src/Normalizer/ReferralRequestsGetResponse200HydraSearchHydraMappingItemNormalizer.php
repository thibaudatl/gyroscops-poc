...
class ReferralRequestsGetResponse200HydraSearchHydraMappingItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ReferralRequestsGetResponse200HydraSearchHydraMappingItem::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ReferralRequestsGetResponse200HydraSearchHydraMappingItem::class === $data::class;
    }
