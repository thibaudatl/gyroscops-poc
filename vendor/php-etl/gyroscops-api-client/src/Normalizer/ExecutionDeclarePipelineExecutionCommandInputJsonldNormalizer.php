...
class ExecutionDeclarePipelineExecutionCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ExecutionDeclarePipelineExecutionCommandInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ExecutionDeclarePipelineExecutionCommandInputJsonld::class === $data::class;
    }
