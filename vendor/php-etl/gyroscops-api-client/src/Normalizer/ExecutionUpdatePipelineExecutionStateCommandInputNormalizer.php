...
class ExecutionUpdatePipelineExecutionStateCommandInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ExecutionUpdatePipelineExecutionStateCommandInput::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ExecutionUpdatePipelineExecutionStateCommandInput::class === $data::class;
    }
