...
class AuthenticationOrganizationIdAuthorizationsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\AuthenticationOrganizationIdAuthorizationsGetResponse200::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\AuthenticationOrganizationIdAuthorizationsGetResponse200::class === $data::class;
    }
