...
class AuthenticationWorkspacesGetResponse200HydraSearchHydraMappingItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\AuthenticationWorkspacesGetResponse200HydraSearchHydraMappingItem::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\AuthenticationWorkspacesGetResponse200HydraSearchHydraMappingItem::class === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\AuthenticationWorkspacesGetResponse200HydraSearchHydraMappingItem();
