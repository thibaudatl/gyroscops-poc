...
class PipelineMoveAfterPipelineStepCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\PipelineMoveAfterPipelineStepCommandInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\PipelineMoveAfterPipelineStepCommandInputJsonld::class === $data::class;
    }
