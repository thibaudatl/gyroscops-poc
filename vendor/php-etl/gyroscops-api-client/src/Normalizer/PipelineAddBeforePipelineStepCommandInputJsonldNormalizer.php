...
class PipelineAddBeforePipelineStepCommandInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\PipelineAddBeforePipelineStepCommandInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\PipelineAddBeforePipelineStepCommandInputJsonld::class === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Gyroscops\Api\Model\PipelineAddBeforePipelineStepCommandInputJsonld();
        ...
        if (\array_key_exists('probes', $data) && null !== $data['probes']) {
            ...
            foreach ($data['probes'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gyroscops\Api\Model\ProbeJsonld::class, 'json', $context);
            }
