...
class RuntimePipelineStepIdProbesGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\RuntimePipelineStepIdProbesGetResponse200HydraSearch::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\RuntimePipelineStepIdProbesGetResponse200HydraSearch::class === $data::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('hydra:mapping', $data) && null !== $data['hydra:mapping']) {
            ...
            foreach ($data['hydra:mapping'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gyroscops\Api\Model\RuntimePipelineStepIdProbesGetResponse200HydraSearchHydraMappingItem::class, 'json', $context);
            }
