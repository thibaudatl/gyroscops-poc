...
class PipelineRemovePipelineStepProbeCommandJsonldReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\PipelineRemovePipelineStepProbeCommandJsonldRead::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\PipelineRemovePipelineStepProbeCommandJsonldRead::class === $data::class;
    }
