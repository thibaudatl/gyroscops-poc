...
class ConfigurationCreateConfigurationInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\ConfigurationCreateConfigurationInput::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\ConfigurationCreateConfigurationInput::class === $data::class;
    }
