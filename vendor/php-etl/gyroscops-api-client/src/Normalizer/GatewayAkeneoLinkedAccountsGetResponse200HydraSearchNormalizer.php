...
class GatewayAkeneoLinkedAccountsGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\GatewayAkeneoLinkedAccountsGetResponse200HydraSearch::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\GatewayAkeneoLinkedAccountsGetResponse200HydraSearch::class === $data::class;
    }
