...
class EnvironmentAddMultipleVariableFromConfigurationInputJsonldNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Gyroscops\Api\Model\EnvironmentAddMultipleVariableFromConfigurationInputJsonld::class === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && \Gyroscops\Api\Model\EnvironmentAddMultipleVariableFromConfigurationInputJsonld::class === $data::class;
    }
